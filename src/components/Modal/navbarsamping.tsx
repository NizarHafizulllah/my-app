...
interface NavbarsampingProps{
    isOpen: boolean
    close: any
    children: ReactNode
}

const NavbarSamping = (props: NavbarsampingProps) => {
    ...
    <>
      ...
      <Dialog as="div" className="relative z-10" onClose={props.close}>
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 bg-gradient-to-b from-gray-600/80 to-gray-900/80 backdrop-blur-sm transition-opacity" />
        </Transition.Child>
